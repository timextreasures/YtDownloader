namespace ytDownloader_GUI
{
    partial class PrintingBox
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cmbQualitySetting = new System.Windows.Forms.ComboBox();
			this.column_Quality = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.SuspendLayout();
			// 
			// button_add
			// 
			...
			// button_download
			// 
			this.button_download.Location = new System.Drawing.Point(12, 149);
			...
			// button_selectDir
			// 
			this.button_selectDir.Location = new System.Drawing.Point(12, 178);
			...
			// cmbQualitySetting
			// 
			this.cmbQualitySetting.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cmbQualitySetting.FormattingEnabled = true;
			this.cmbQualitySetting.Items.AddRange(new object[] {
            "Super High",
            "High",
            "Medium",
            "Low"});
			this.cmbQualitySetting.Location = new System.Drawing.Point(12, 88);
			this.cmbQualitySetting.Name = "cmbQualitySetting";
			this.cmbQualitySetting.Size = new System.Drawing.Size(160, 21);
			this.cmbQualitySetting.TabIndex = 15;
			this.cmbQualitySetting.SelectedIndexChanged += new System.EventHandler(this.comboBox1_SelectedIndexChanged_1);
			// 
			// column_Quality
			// 
			this.column_Quality.Text = "Quality";
			this.column_Quality.Width = 94;
			// 
			// PrintingBox
			// 
			...
			this.Controls.Add(this.cmbQualitySetting);
		...
		private System.Windows.Forms.ComboBox cmbQualitySetting;
		private System.Windows.Forms.ColumnHeader column_Quality;
	}
}
